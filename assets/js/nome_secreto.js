...
addEventListener("keydown", (e) => {
    ...
    if (!(letra === "p" || letra === "a" || letra === "u" || letra === "l" || letra === "o" || letra === "e" || letra == "d" || letra === "r") )
    ...
    if (nomeCorreto === "paulo") {
        window.document.body.innerHTML =
            `
                            <div class="telaAestetic">
                                <h1 class="titleAestetic">NOME: ${nomeCorreto.toUpperCase()}</h2>
                                </br>
        ...
        const espera = () =>{
            setInterval(() => {
                window.location.href = "ìndex.html" //segunda pagina
            },3000)
        }
        espera()
    ...
    if ((nomeCorreto !== "paulo") && digitados === 5) {
        window.document.body.innerHTML = `<h1 class="avisoAestetic">NOME ERRADO !!</h1>`
        const espera = () =>{
            setInterval(() => {
